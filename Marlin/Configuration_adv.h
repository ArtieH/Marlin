...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN SERVO00_PIN //RTH-1           // Set a custom pin for the controller fan
 ...
 */
//#define E0_AUTO_FAN_PIN SERVO1_PIN //rth -1
...
// @section bltouch
  ...
  #define BLTOUCH_HS_MODE true
    ...
    #define BLTOUCH_HS_EXTRA_CLEARANCE    0 // 7 Extra Z Clearance //AVH
  #endif
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  //#define SDCARD_SORT_ALPHA //AVH Disabled due to compile error for reamp card.
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.058 //0.02 AVH 5/23/26  // (mm) Compression length for all extruders. Override with 'M900 K<mm>'.
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      12   // Should be 12.5 but can't do floating point numbers. Was 105  // (mm) The length of filament for a complete unload.
 ...
 */
#define STARTUP_COMMANDS "M206 X3 Y4 \n M500"
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_3_GCODE "M104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND) "\nM702\nM104 S0\nM300"
  //#define MAIN_MENU_ITEM_3_CONFIRM
    //#define MAIN_MENU_ITEM_3_IMMEDIATE

  #define MAIN_MENU_ITEM_4_DESC "Load " PREHEAT_2_LABEL
  #define MAIN_MENU_ITEM_4_GCODE "M104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND) "\nM701\nM104 S0"
  //#define MAIN_MENU_ITEM_4_CONFIRM
    //#define MAIN_MENU_ITEM_4_IMMEDIATE

  #define MAIN_MENU_ITEM_5_DESC "Unload " PREHEAT_2_LABEL
  #define MAIN_MENU_ITEM_5_GCODE "M104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND) "\nM702\nM104 S0\nM300"
