...
#define STRING_CONFIG_H_AUTHOR "ArtiH - November 4, 2024" // Who made the changes.
...
// Set standby for the unselected tool with M104/106/109 T...
  ...
  #define SINGLENOZZLE_STANDBY_TEMP 190 //AVH
...
#define DELTA
  ...
  // G33 Delta Auto-Calibration. Enable EEPROM_SETTINGS to store results.
    ...
    #define DELTA_DIAGONAL_ROD 272.04        // (mm)
    ...
    #define DELTA_RADIUS 133.95 

    //   std dev:0.037 11/8/2024
    ...
    // Horizontal distance bridged by diagonal push rods when effector is centered.
               // (mm) Get this value from G33 auto calibrate
  #endif

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 275.42             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ {  -0.16, 0.00, -0.46 } // (mm) Get these values from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM {  -0.08, 0.01, 0.07} // (mm) Get these values from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.0757, 80.1810, 80.0595, 96.038, 138.525 }  // default steps per unit for Kossel (10/25/2024)																			  
...
#define DEFAULT_EJERK    16.0 // 5.0  // May be used by Linear Advance AVH
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -15.26 }
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_BD 140.37
  #define XY_SIDE_AD 99.46
 ...
 */
#define DISPLAY_CHARSET_HD44780 WESTERN // JAPANESE  //AVH
...
#define ST7920_DELAY_1 DELAY_NS(0) //AVH
