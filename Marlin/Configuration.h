...
#define STRING_CONFIG_H_AUTHOR "ArtieH 1/26/2026, HEVO BLTouch/TMC2208" // Original author or contributor.
...
#define PROBING_MARGIN 40 //25 AVH 5/23/26

// X and Y axis travel speed between probes.
// Leave undefined to use the average of the current XY homing feedrate.
#define XY_PROBE_FEEDRATE (250*60) //(133*60)
...
#define Z_CLEARANCE_BETWEEN_PROBES  12 // (mm) Z Clearance between probe points
...
#define INVERT_X_DIR false /for TMC step sticks
#define INVERT_Y_DIR false
#define INVERT_Z_DIR false
//#define INVERT_I_DIR false
//#define INVERT_J_DIR falsefalse
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 3 //10.0 // (mm) Default fade height.
  #endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 150), (Y_MIN_POS + 19), 20 }
